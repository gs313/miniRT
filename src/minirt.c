...
/*   Updated: 2024/08/26 23:19:44 by scharuka         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	//two spheres
	scene = scene_init(2);
	cylinder_init(0,&scene.obj[0], vec_init(0, 10, 50), vec_init(0, 1, 1), 50, 255, 0, 5, 10);

	sphere_init(1, &scene.obj[1], vec_init(5, 5, 20), 0, 255, 0, 5);
	...
	// plane_init(0, &scene.obj[0], vec_init(0, 5, 0), vec_init(0, 1, 0), 0, 255, 0);
